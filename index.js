...
reviews.push({name: "Yo", rating: 4, feedback:"Simple"})
for (let i = 0; i < reviews.length; i++) {
...
function getReviewByIndex(array, index) {
  ...
  // return (list[place].name + " gave the restaurant a " + list[place].rating + " star review, and their feedback was: " + list[place].feedback);
